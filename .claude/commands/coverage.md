---
description: Roda os testes com cobertura e verifica o gate de 80% (critério do SonarCloud), listando o que falta cobrir.
allowed-tools: Bash(make:*), Bash(pytest:*)
---

Rode a suíte com cobertura e avalie contra o **gate de ≥ 80%** — o mesmo critério que o SonarCloud aplica na esteira.
...
Ao final:
- Informe a **cobertura total** (%) e se atinge o gate de 80%.
- Se estiver **abaixo de 80%**, liste os arquivos de `src/` com menor cobertura e as
